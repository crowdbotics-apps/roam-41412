"""
Django settings for roam_41412 project.
...
WSGI_APPLICATION = 'roam_41412.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "roam_41412 API",
    "DESCRIPTION": "API documentation for roam_41412 App",
    "VERSION": "v1",
}
